                            ...
                            <div class="column is-6">
                                <div class="field is-horizontal">
                                    <div class="field-body">
                                        <div class="field">
                                            <p class="control">
                                                <input data-start-date="2019-03-11" data-date-format="YYYY-MM-DD" data-show-footer="false" id="date" type="date" name="date" data-close-on-select="false" data-today-button="false" data-display-mode="inline" data-lang="fr" value="{{ old('date') }}" required autofocus>
                                            </p>
